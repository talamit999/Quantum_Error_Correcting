...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\טל\PycharmProjects\Quantum_Error_Correcting'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\טל\PycharmProjects\Quantum_Error_Correcting\Scripts\deactivate.nu'
