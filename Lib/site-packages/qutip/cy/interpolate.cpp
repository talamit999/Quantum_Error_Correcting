 ...
 *     cdef int lenc = c.shape[0]
 */
  __pyx_tuple__27 = PyTuple_Pack(15, __pyx_n_s_x, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_c, __pyx_n_s_lenx, __pyx_n_s_lenc, __pyx_n_s_n, __pyx_n_s_h, __pyx_n_s_ii, __pyx_n_s_jj, __pyx_n_s_l, __pyx_n_s_m, __pyx_n_s_pos, __pyx_n_s_tmp, __pyx_n_s_out); if (unlikely(!__pyx_tuple__27)) __PYX_ERR(0, 63, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__27);
  __Pyx_GIVEREF(__pyx_tuple__27);
  __pyx_codeobj__28 = (PyObject*)__Pyx_PyCode_New(4, 0, 15, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__27, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_qutip_cy_interpolate_pyx, __pyx_n_s_arr_interp, 63, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__28)) __PYX_ERR(0, 63, __pyx_L1_error)
 ...
 *     cdef int lenc = c.shape[0]
 */
  __pyx_tuple__29 = PyTuple_Pack(15, __pyx_n_s_x, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_c, __pyx_n_s_lenx, __pyx_n_s_lenc, __pyx_n_s_n, __pyx_n_s_h, __pyx_n_s_ii, __pyx_n_s_jj, __pyx_n_s_l, __pyx_n_s_m, __pyx_n_s_pos, __pyx_n_s_tmp, __pyx_n_s_out); if (unlikely(!__pyx_tuple__29)) __PYX_ERR(0, 89, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__29);
  __Pyx_GIVEREF(__pyx_tuple__29);
  __pyx_codeobj__30 = (PyObject*)__Pyx_PyCode_New(4, 0, 15, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__29, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_qutip_cy_interpolate_pyx, __pyx_n_s_arr_zinterp, 89, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__30)) __PYX_ERR(0, 89, __pyx_L1_error)
